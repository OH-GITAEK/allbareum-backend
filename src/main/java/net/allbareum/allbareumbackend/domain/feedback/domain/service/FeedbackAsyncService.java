...
public class FeedbackAsyncService {
    ...
    public CompletableFuture<ResponseEntity<Map>> getPronunciationFeedback(PronunciationFeedbackCreateRequestDto pronunciationFeedbackCreateRequestDto) throws IOException {
        // 1. 음성 파일 바이트 배열로 변환
